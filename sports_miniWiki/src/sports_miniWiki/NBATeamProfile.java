		...
		for (String nbaTeam: team.keySet()) {
			...
			switch (nbaTeam) {
				...
				case "Oklahoma City Thunder":
					NBATeam t4 = null;
					String url4 = "http://api.sportradar.us/nba-t3/teams/" + team.get("Oklahoma City Thunder") + "/profile.json?api_key=79jjegg7pncfakwtjkta25y2";
				...
				case "Los Angeles Clippers":
					NBATeam t5 = null;
					String url5 = "http://api.sportradar.us/nba-t3/teams/" + team.get("Los Angeles Clippers") + "/profile.json?api_key=79jjegg7pncfakwtjkta25y2";
				...
				case "Indiana Pacers":
					NBATeam t6 = null;
					String url6 = "http://api.sportradar.us/nba-t3/teams/" + team.get("Indiana Pacers") + "/profile.json?api_key=79jjegg7pncfakwtjkta25y2";
				...
				case "Chicago Bulls":
					NBATeam t7 = null;
					String url7 = "http://api.sportradar.us/nba-t3/teams/" + team.get("Chicago Bulls") + "/profile.json?api_key=79jjegg7pncfakwtjkta25y2";
