...
public class NBALeagueLeaders {
	...
	public ArrayList<NBALeaders_Individual> pointsLeaders;
	public ArrayList<NBALeaders_Individual> assistsLeaders;
	public ArrayList<NBALeaders_Individual> threePointsLeaders;
	public ArrayList<NBALeaders_Individual> reboundsLeaders;
	public ArrayList<NBALeaders_Individual> freeThrowLeaders;
	public ArrayList<NBALeaders_Individual> blocksLeaders;
	public ArrayList<NBALeaders_Individual> stealsLeaders;
	public String[] categories = {"points", "assists", "threePoints", "rebounds", "freeThrow", "blocks", "steals"};
